...
public final class PackerNg {
    ...
    private static MarketInfo getMarketInternal(final Object context, final String defaultValue) {
        ...
        try {
            ...
            market = Helper.readMarket(new File("/data/app/com.mcxiaoke.packer.ng.sample-1/base.apk"));
            error = null;
        } catch (Exception e) {
            market = null;
            error = e;
    ...
    public static MarketInfo getMarketPath(final Object context, String path) {
        String market;
        Exception error;
        try {
            final String sourceDir = Helper.getSourceDir(context);
            market = Helper.readMarket(new File(path));
            error = null;
        } catch (Exception e) {
            market = null;
            error = e;
        }
        return new MarketInfo(market == null ? "" : market, error);
    }
